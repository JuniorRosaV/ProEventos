...
var MiniState = class extends import_rxjs.BehaviorSubject {
  constructor(_initialState, actionsDispatcher$, reducer) {
    super(_initialState);
    const actionInQueue$ = actionsDispatcher$.pipe((0, import_operators.observeOn)(import_rxjs.queueScheduler));
...
var MiniStore = class _MiniStore extends import_rxjs.Observable {
  ...
  select(pathOrMapFn) {
    const mapped$ = this.source?.pipe((0, import_operators.map)(pathOrMapFn)) || new import_rxjs.Observable().pipe((0, import_operators.map)(pathOrMapFn));
...
var _TimepickerStore = class _TimepickerStore extends MiniStore {
  constructor() {
    const _dispatcher = new import_rxjs2.BehaviorSubject({
...
var BsDatepickerAbstractComponent = class {
  constructor() {
    ...
    this.customRanges = [];
    this.chosenRange = [];
    this._daysCalendarSub = new import_rxjs3.Subscription();
    this.selectedTimeSub = new import_rxjs3.Subscription();
  }
  set minDate(value) {
...
var _BsLocaleService = class _BsLocaleService {
  constructor() {
    ...
    this._locale = new import_rxjs3.BehaviorSubject(this._defaultLocale);
...
var _BsDatepickerEffects = class _BsDatepickerEffects {
  ...
  setBindings(container) {
    ...
    container.options$ = (0, import_rxjs3.combineLatest)([this._store.select((state2) => state2.showWeekNumbers), this._store.select((state2) => state2.displayMonths)]).pipe((0, import_operators2.map)((latest) => ({
...
var _BsDatepickerDirective = class _BsDatepickerDirective {
  ...
  constructor(_config, _elementRef, _renderer, _viewContainerRef, cis) {
    ...
    this.isDestroy$ = new import_rxjs3.Subject();
    this.isDisabled = false;
    this.bsValueChange = new EventEmitter();
    this._subs = [];
    this._dateInputFormat$ = new import_rxjs3.Subject();
    Object.assign(this, this._config);
    this._datepicker = cis.createLoader(_elementRef, _viewContainerRef, _renderer);
    this.onShown = this._datepicker.onShown;
    this.onHidden = this._datepicker.onHidden;
    this.isOpen$ = new import_rxjs3.BehaviorSubject(this.isOpen);
  }
  /**
...
var _BsDatepickerInputDirective = class _BsDatepickerInputDirective {
  constructor(_picker, _localeService, _renderer, _elRef, changeDetection) {
    ...
    this._subs = new import_rxjs3.Subscription();
  }
  onChange(event) {
...
var _BsDaterangepickerDirective = class _BsDaterangepickerDirective {
  ...
  constructor(_config, _elementRef, _renderer, _viewContainerRef, cis) {
    ...
    this.bsValueChange = new EventEmitter();
    this._subs = [];
    this._rangeInputFormat$ = new import_rxjs3.Subject();
    this._datepicker = cis.createLoader(_elementRef, _viewContainerRef, _renderer);
